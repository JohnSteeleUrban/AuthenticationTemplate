...
<script runat="server">
	...
	private void PopulateTree(string byUsersOrRole)
	{
		/*
		 * Dan Clem, 4/15/2007.
		...
		TreeNode root = AddNodeAndDescendents(byUsersOrRole, rootFolder, null);
		FolderTree.Nodes.Add(root);
	}
	
	private TreeNode AddNodeAndDescendents(string byUserOrRole, System.IO.DirectoryInfo folder, TreeNode parentNode)
	{
		/*
		 * Dan Clem, 4/15/2007.
		 * The PopulateTree and AddNodeAndDescendents are taken almost verbatim from Scott Mitchell's article
