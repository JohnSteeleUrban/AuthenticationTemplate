...
<script runat="server">
	...
	private void PopulateTree()
	{
		...
		System.IO.DirectoryInfo rootFolder = new System.IO.DirectoryInfo(Server.MapPath(VirtualImageRoot));
	...
	private TreeNode AddNodeAndDescendents(System.IO.DirectoryInfo folder, TreeNode parentNode)
	{
		/*
		 * Dan Clem, 4/15/2007.
		 * The PopulateTree and AddNodeAndDescendents are taken almost verbatim from Scott Mitchell's article
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
	...
	<table class="dtable" border="0" width="600">
		<tr>
			<th>
		...
		<tr>
			<td class="details" valign="top" >
				...
				<p>
					Use this page to manage access
					rules for your Web site. Rules
					are applied to folders, <br/>thus providing
					robust folder-level security enforced
					by the ASP.NET infrastructure.<br/>
					Rules are persisted as XML in
					each folder's Web.config file.
					<i>Page-level security and inner-page<br/>
						security are not handled using
						this tool &mdash; they are handled
						using specialized code that is<br/>
						available to the Web Developers.</i>
				</p>
				<table>
					<tr>
						...
						<td valign="top" style="padding-left: 30px;
							...
							<asp:Panel runat="server" ID="SecurityInfoSection"
								Visible="false">
								<h2 runat="server" id="TitleOne"
									class="alert"></h2>
								<p style="width: 900px">
									Rules are applied in order. The
									first rule that matches applies,
									and the permission in each rule
									overrides the permissions in all
									following rules. Use the Move
									Up and Move Down buttons to change
									the order of the selected rule.
									Rules that appear dimmed are inherited
									from the parent and cannot be
									changed at this level.
								</p>
								<center>
								<asp:GridView runat="server" ID="RulesGrid"
									AutoGenerateColumns="false"
									GridLines="none"
									OnRowDataBound="RowDataBound" CssClass="dtable">
									<Columns>
								...
								<table class="dtable">
									...
									<tr>
										<td align="left">
											<asp:RadioButton runat="server" ID="ApplyRole" GroupName="applyto" Text="This Role:"
												Checked="true" />
									...
									<tr>
										<td align="left">
											<asp:RadioButton runat="server" ID="ApplyUser" GroupName="applyto" Text="This User:" />
